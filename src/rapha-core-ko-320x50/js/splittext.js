...
! function(e) {
    ...
    var t = e.GreenSockGlobals || e,
        ...
        s = function(e) {
            var t = e.nodeType,
                i = "";
            if (1 === t || 9 === t || 11 === t) { if ("string" == typeof e.textContent) return e.textContent; for (e = e.firstChild; e; e = e.nextSibling) i += s(e) } else if (3 === t || 4 === t) return e.nodeValue;
            return i
        },
        r = document,
        l = r.defaultView ? r.defaultView.getComputedStyle : function() {},
        o = /([A-Z])/g,
        d = function(e, t, i, n) { var s; return (i = i || l(e, null)) ? (e = i.getPropertyValue(t.replace(o, "-$1").toLowerCase()), s = e || i.length ? e : i[t]) : e.currentStyle && (i = e.currentStyle, s = i[t]), n ? s : parseInt(s, 10) || 0 },
        p = function(e) { return e.length && e[0] && (e[0].nodeType && e[0].style && !e.nodeType || e[0].length && e[0][0]) ? !0 : !1 },
        a = function(e) {
            var t, i, n, s = [],
                r = e.length;
            for (t = 0; r > t; t++)
        ...
        S = 127995,
        v = 127999,
        b = function(e) { return (e.charCodeAt(0) - f << 10) + (e.charCodeAt(1) - g) + 65536 },
        ...
        C = function(e, t) {
            ...
            return i && (e = e.split("++").join("")),
                function() { return "<" + t + m + (e ? " class='" + e + (i ? n++ : "") + "'>" : ">") }
        },
        ...
        w = function(e, t) { var i = t.length; for (; --i > -1;) e.push(t[i]) },
        A = function(e) {
            var t, i = [],
                n = e.length;
        ...
        H = function(e, t, i, n) {
            ...
            if (3 !== e.nodeType || o > 1) { for (t.absolute = !1, s = 0; o > s; s++) r = l[s], (3 !== r.nodeType || /\S+/.test(r.nodeValue)) && (p && 3 !== r.nodeType && "inline" === d(r, "display", null, !0) && (r.style.display = "inline-block", r.style.position = "relative"), r._isSplit = !0, H(r, t, i, n)); return t.absolute = p, void(e._isSplit = !0) }
            W(e, t, i, n)
        },
        E = T.prototype;
    E.split = function(e) {
    ...
    }, E.revert = function() { if (!this._originals) throw "revert() call wasn't scoped properly."; var e = this._originals.length; for (; --e > -1;) this.elements[e].innerHTML = this._originals[e]; return this.chars = [], this.words = [], this.lines = [], this.isSplit = !1, this }, T.selector = e.$ || e.jQuery || function(t) { var i = e.$ || e.jQuery; return i ? (T.selector = i, i(t)) : "undefined" == typeof document ? t : document.querySelectorAll ? document.querySelectorAll(t) : document.getElementById("#" === t.charAt(0) ? t.substr(1) : t) }, T.version = "0.5.8"
}(_gsScope),
function(e) { "use strict"; var t = function() { return (_gsScope.GreenSockGlobals || _gsScope)[e] }; "undefined" != typeof module && module.exports ? module.exports = t() : "function" == typeof define && define.amd && define([], t) }("SplitText");